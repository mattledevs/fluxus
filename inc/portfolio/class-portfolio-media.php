...
class PortfolioMedia extends FluxusPage {
    ...
    function get_alt() {
        ...
        if ( ! $alt ) {
            if ( $this->is_image() ) {
                $data = $this->get_image_data( 'fluxus-max' );
                if ( $data ) {
                    $alt = $data['title'];
                }
            }
    ...
    function get_thumbnail( $size = 'fluxus-thumbnail' ) {

        if ( $this->is_image() ) {
            return $this->get_image_data( $size );
        } else {
            return $this->get_video_thumbnail( 'fluxus-thumbnail' );
        }

    }

    function get_video_thumbnail( $size = 'fluxus-thumbnail' ) {
