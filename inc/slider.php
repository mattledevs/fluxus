...
function fluxus_slider_media_tab_content() {
    ...
    ?>
    <div id="fluxus-slider-tab">
        <table class="widefat" cellspacing="0" id="fluxus-slider-slides">
            <thead>
                <tr>
            ...
            <tbody><?php
                ...
                if ( $slides ) :
                            ...
                            <td>
                                ...
                                <div class="details" id="slide_<?php echo $id; ?>_details">
                                    <form enctype="multipart/form-data" method="post" action="/">
                                        ...
                                        <div class="field">
                                            <label><?php _e( 'Image position', 'fluxus' ); ?></label><?php

                                            $options = array(
                                                    'top center'    => __( 'Top', 'fluxus' ),
                                                    'center center' => __( 'Middle', 'fluxus' ),
                    ...
                    <tr>
                        <td colspan="4">
                            <?php _e( 'No images added to gallery.', 'fluxus' ); ?>
                        </td>
                    </tr><?php
                endif; ?>
            </tbody>
        ...
        <form enctype="multipart/form-data" method="post" action="/">
            ...
            <div class="save-changes">
                <span class="saving-order-status" data-saving="<?php _e( 'Saving...', 'fluxus' ); ?>" data-ok="<?php _e( 'Saved!', 'fluxus' ); ?>" data-failed="<?php _e( 'Failed', 'fluxus' ); ?>"></span>
                <a href="#" class="button" id="save-slide-order"><?php _e( 'Save ordering changes', 'fluxus' ); ?></a>
            </div>
        </form>
